...
class Train_Staff(User):
    ...
    def login(self):
        ...
        while True:
            ...
            choice = (
                input("Do you want to back to the Main Panel (yes/no) ? : ")
                .strip()
                .lower()
            )
            if choice == "yes":
                ...
                if len(employee_dict) == 0:
                    print(
                        "There is no users registered! Please call your admin to register you!\n"
                    )
                    start.display_start_panel()
                    break
    ...
    def add_train_line(self):
        ...
        while True:
            # get user inputs .
            name_line = input("Enter name_line : ").strip().lower()
            ...
            choice = (
                input("Do you want to enter another set of input (yes/no) ? : ")
                .strip()
                .lower()
            )
            if choice != "yes":
    ...
    def remove_line(self):
        ...
        while True:
            ...
            name_line = (
                input("Enter the name line for delete or 'quit' for exit : ")
                .strip()
                .lower()
            )
            ...
            # check if name_line exists in train_line dictionary
                ...
                if choice == "yes":
                    ...
                    name_train_remove.append(name_line)
                    del line_dic[name_line]
                    print("The name line was deleted successfully !\n")

                else:
                    print(
                        f"The {name_line} information was not deleted successfully!\n"
                    )
                    self.display_train_panel()
                    break
    ...
    def view_lines(self):
        ...
        if not line_dic:
            ...
            choice = (
                input("Do you want to add an information (yes/no) ? : ").strip().lower()
            )
    ...
    def update_line(self):
        ...
        while True:
            ...
            # get inputs .
            name_line = input(
                "Enter the name line to update it or type 'quit' to exit: "
            )
            ...
            if name_line == "quit":
                ...
                # the update panel .
                    ...
                    if change == "2":
                        new_value = input(
                            f"Please enter the new value for {change} : "
                        ).strip()

                        choice = (
                            input("Do you want to change the origin (yes/no) ? : ")
                            .strip()
                            .lower()
                        )
                    ...
                    # destination change .
                        ...
                        choice = (
                            input("Do you want to change the destination (yes/no) ? : ")
                            .strip()
                            .lower()
                        )
                    ...
                    # num_state change .
                        ...
                        new_value = int(
                            input(f"Please enter the new value for {change}: ").strip()
                        )

                        choice = (
                            input("Do you want to change the num state (yes/no) ? : ")
                            .strip()
                            .lower()
                        )
                    ...
                    # list_state change .
                        ...
                        choice = (
                            input(
                                "Do you want to change the list state value (yes/no) ? : "
                            )
                            .strip()
                            .lower()
                        )
                    ...
                    # name_line change .
                        ...
                        new_value = (
                            input(f"Please enter the new name for {change}: ")
                            .strip()
                            .slower()
                        )

                        choice = (
                            input("Do you want to change the name line (yes/no) ? : ")
                            .strip()
                            .lower()
                        )

                        if choice == "yes":
                            name_line_dic[name_line] = new_value
    ...
    def add_train(self):
        ...
        while True:
            id_train = input("Enter train ID : ").strip().lower()
            ...
            # get inputs .
            name_train = input("Enter train name: ").strip()
            name_line = input("Enter line name: ").strip()
            ...
            print(
                f"Train {name_train} with ID {id_train} has been added successfully!\n"
            )

            choice = (
                input("Do you want to add another train (yes/no) ? : ").strip().lower()
            )
            if choice != "yes":
                self.display_train_panel()
                break
    ...
    def remove_train(self):
        ...
        while True:
            ...
            id_train = (
                input("Enter the train ID to delete or 'quit' for exit : ")
                .strip()
                .lower()
            )
    ...
    def view_trains(self):
        ...
        if not train_dic:
            ...
            choice = (
                input("Do you want to add an train information (yes/no) ? : ")
                .strip()
                .lower()
            )
    ...
    def update_train(self):
        "This is method lets the employee to update atrain on a line"
        ...
        # print(train_dic)
        # print(name_line_dic)
        # print(name_train_remove)

        while True:
            # get id to find the train
            id_train = (
                input("Enter train ID to update or 'quit' for exit : ").strip().lower()
            )
            ...
            # checks the id is available or not .
                ...
                if choice == "no":
                    ...
                    print("The train has been update!\n")
                    name_line = train_dic[id_train]["name_line"]

                    # check the name of line change and the train remove and add again
                    if name_line_dic.get(name_line):
                        del train_dic[id_train]
                        self.add_train

                    # name_line no change but numbers of station and name of stations  change
                    if name_line in line_dic:
                        if list_state_for_train != line_dic[name_line]["list_state"]:
                            del train_dic[id_train]
                            self.add_train()

                    # check the name of line no in list of information_lines
                    if name_line not in line_dic:
                        print(f"The {name_line} does not exist.the train must be move")
                        del train_dic[id_train]
                        print(f"The  train with ID{id_train}  was deleted successfully !\n")
